...
<nav id="sidebar" class="bg-body-tertiary shadow">
    <div class="text-center sidebar-header pt-3 ps-0">
        <b class="gradient-animate-small">Leave Application System</b>
    </div>
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            ?>
            <li class="menu-item">
            <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-pen-to-square"></i> Applications'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
            </li>
            ...
            <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-circle-info"></i> Documents'), ['controller' => 'Pages', 'action' => 'manual', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <?php if ($this->Identity->isLoggedIn()) { ?>
                    <li class="menu-item">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-pen-to-square"></i> Applications <span class="badge text-bg-warning">' . $total_applications_pending . ' </span>'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-building"></i> Departments'), ['controller' => 'Departments', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-coins"></i> Types'), ['controller' => 'Types', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-circle-user"></i> Staffs'), ['controller' => 'Staffs', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>    
