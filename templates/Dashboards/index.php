	...
	<div class="col-md-9 border-end">
		...
		<div class="row px-2 mb-4">
			<div class="col-md-3 border rounded-start pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_app; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Applications
			</div>
			<div class="col-md-3 border pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_staff; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Staffs
			</div>
			<div class="col-md-3 border pt-3 pb-3 bg-body-tertiary">
				<span class="fs-3"><?php echo $total_dept; ?> <i class="fa-solid fa-caret-up text-primary"></i></span><br />
				Total Department
			</div>
